...
def hangman():
    word=random.choice(["pineapple","custard","science","engish","story","terminal","command","solar","environment","ocean","superman","batman","forest","mountain","nation","asia","europe","virtual"])
